...
#ifndef NUMERICALANALYSIST8_ZERORANGEGUARD_H
#define NUMERICALANALYSIST8_ZERORANGEGUARD_H
...
private:
    inline static std::vector<double> rangeList{1E-12};
};

#endif //NUMERICALANALYSIST8_ZERORANGEGUARD_H
